...
set PATH=%CMAKE_DIR%;%NINJA_DIR%;%PWSH_DIR%;%SEVENZIP_DIR%;%QT6_DIR%\bin;%PATH%

cd /d "D:\Project_vibecoding\NovaChat"
ctest --preset windows-debug -V > D:\Project_vibecoding\NovaChat\test_output.txt 2>&1
echo Exit code: %ERRORLEVEL% >> D:\Project_vibecoding\NovaChat\test_output.txt
